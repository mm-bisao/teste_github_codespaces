...
class TestDouble(unittest.TestCase): 
    ...
    def test1(self): 
        ...
        self.assertEqual(add(0, 0), 0) # test when 2 is given as input the output is 4.
        self.assertEqual(add(2.3, 3.6), 5.9) # test when 2 is given as input the output is 4. 
        self.assertEqual(add('hello ', 'world'), 'hello world') # test when 2 is given as input the output is 4.
        self.assertEqual(add(2.30000, 4.3000), 6.6) # test when 2 is given as input the output is 4. 
        self.assertNotEqual(add(-2, -2), 0) # test when 2 is given as input the output is 4.
